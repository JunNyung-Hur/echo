...
This source tree targets **0.0.4**. See [release preparation notes](docs/public/release-notes/0.0.4.md); downloadable installers are listed separately on [GitHub Releases](https://github.com/JunNyung-Hur/echo/releases).
